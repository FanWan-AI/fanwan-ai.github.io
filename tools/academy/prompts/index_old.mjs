...
约束：
1. 至少 2 道题要求计算具体指标或解释代码输出，必须引用 lesson worked example 中的数字或表。
2. 每道题都要指出 source_section，与正文保持一致。
3. 解析需说明为什么选项正确/错误，并引用参考章节或公式。
4. 语言要求与正文一致（中英双语）。
5. 禁止使用通用占位题（如“总结本课重点”）。`;
